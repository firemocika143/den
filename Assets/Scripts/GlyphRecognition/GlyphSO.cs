...
public class GlyphSOEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUI.PropertyField(new Rect(10, 10, Screen.width - 100, 20), minMatchProperty);
        EditorGUI.PropertyField(new Rect(10, 50, Screen.width - 100, 100), pointsProperty, true);
